            ...
            <section className='landing-section'>
                ...
                <div className='landing-text'>
                    ...
                    <h1 className='landing-title'>
                        No Product <span style={{ color: '#c4956a' }}>found</span>
                    </h1>

                    <p className='landing-body'>
                        No products available at the moment. We're preparing something fresh and exciting for you. Stay tuned for our latest arrivals.
                    </p>
