...
export default function Products() {
    const [products] = useState([
        ...
        { name: "product2", src: "/12.webp", title: "Abstract Canvas Art", price: "$150" },
        { name: "product3", src: "/05_UVMarble.webp", title: "Luxury Texture Panel", price: "$200" },
        ...
        { name: "product6", src: "/13_UVMarble_WallDecor.webp", title: "Minimal Frame Design", price: "$160" },
        { name: "product7", src: "/08_WallDecor.webp", title: "Premium Wall Piece", price: "$300" },
        { name: "product8", src: "/01_UVMarble.webp", title: "Designer Decor Panel", price: "$220" },
    ])
            ...
            <section className='products-section'>
                ...
                <div style={{ marginBottom: '40px' }}>
                    ...
                    <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: '13px', color: '#3a3a3a', marginTop: '12px', maxWidth: '440px', lineHeight: 1.7 }}>
                        Discover our most loved pieces crafted to elevate your space with timeless elegance and premium design aesthetics.
                    </p>
                </div>
                        ...
                        <div className="modal-box" onClick={(e) => e.stopPropagation()}>
                            ...
                            <div className="modal-grid">
                                ...
                                <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                                    ...
                                    <div>
                                        <label style={{ fontFamily: "'DM Sans', sans-serif", fontSize: '12px', color: 'black', display: 'block', marginBottom: '6px' }}>Quantity</label>
                                        <input
                                            type="number"
                                            min="1"
                                            defaultValue="1"
                                            className='text-black placeholder:text-black'
                                            style={{ border: '1px solid #E8E4DF', padding: '10px 14px', width: '80px', fontFamily: "'DM Sans', sans-serif", fontSize: '14px', borderRadius: '4px', outline: 'none'  , color: '#000' }}
                                        />
                                    </div>
                                    <button
