...
export default function Items() {
    const [products] = useState([
        { name: "product1", src: "/03_WallDecor.webp", title: "Marble Wall Frame", price: "$120" },
        { name: "product2", src: "/04_WallDecor.webp", title: "Abstract Canvas Art", price: "$150" },
        { name: "product3", src: "/05_UVMarble_WallDecor.webp", title: "Luxury Texture Panel", price: "$200" },
        { name: "product4", src: "/06_UVMarble_WallDecor.webp", title: "Modern Wall Decor", price: "$180" },
        { name: "product5", src: "/13.webp", title: "Golden Pattern Art", price: "$250" },
        { name: "product6", src: "/12.webp", title: "Minimal Frame Design", price: "$160" },
        { name: "product7", src: "/07_UVMarble_WallDecor.webp", title: "Premium Wall Piece", price: "$300" },
        { name: "product8", src: "/08_WallDecor.webp", title: "Designer Decor Panel", price: "$220" },


        { name: "product1", src: "/09__WallDecor.webp", title: "Marble Wall Frame", price: "$120" },
        { name: "product2", src: "/10__WallDecor.webp", title: "Abstract Canvas Art", price: "$150" },
        { name: "product3", src: "/11_WallDecor.webp", title: "Luxury Texture Panel", price: "$200" },
        { name: "product4", src: "/12_WallDecor.webp", title: "Modern Wall Decor", price: "$180" },
        { name: "product5", src: "/13_UVMarble_WallDecor.webp", title: "Golden Pattern Art", price: "$250" },
        { name: "product6", src: "/14_WallDecor.webp", title: "Minimal Frame Design", price: "$160" },
        { name: "product7", src: "/15_WallDecor.webp", title: "Premium Wall Piece", price: "$300" },
        { name: "product8", src: "/16_WallDecor.webp", title: "Designer Decor Panel", price: "$220" },


        { name: "product1", src: "/17_UVMarble_WallDecor.webp", title: "Marble Wall Frame", price: "$120" },
        { name: "product2", src: "/18_WallDecor.webp", title: "Abstract Canvas Art", price: "$150" },
        { name: "product3", src: "/19_WallDecor.webp", title: "Luxury Texture Panel", price: "$200" },
        { name: "product4", src: "/21_wallDecor.webp", title: "Modern Wall Decor", price: "$180" },
        { name: "product5", src: "/13.webp", title: "Golden Pattern Art", price: "$250" },
        { name: "product6", src: "/12.webp", title: "Minimal Frame Design", price: "$160" },
        { name: "product7", src: "/20.png", title: "Premium Wall Piece", price: "$300" },
        { name: "product8", src: "/21.png", title: "Designer Decor Panel", price: "$220" },
